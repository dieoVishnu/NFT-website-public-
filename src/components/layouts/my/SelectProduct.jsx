    ...
    return <div>
        <section className="sc-card-blog bg-color">
            <div className="section-card-single">
                <div className="row">
                    <div ref={myRef1} className="col-lg-6 p-0 sc-product-item">
                        <div className="section-card-single" >
                            <div className="selectItem-card1 product-img">
                                <div className="iterm">
                                <Link to="/blog/1"
                                    className="selectitem-text heading"><span>shop <br />classic <br /> cars </span></Link>
                                </div>
                                
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 sc-product-item p-0">
                        <div className="section-card-single">
