...
echo json_encode(["success"=>true,"account"=>true]);
// $postID = postNewId($conn);
// $catchData = json_decode(file_get_contents("php://input"));;

// $postCategory = $catchData['uploadPhoto'];

// if ($postID != null) {
//     echo json_encode(["success"=>true,"account"=>true,"usersid"=>$catchData,"user_Name" => $postCategory]);
